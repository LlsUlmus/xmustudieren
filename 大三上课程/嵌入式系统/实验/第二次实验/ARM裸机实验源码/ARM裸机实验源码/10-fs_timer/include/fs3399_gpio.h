...
//Address mapping
#define     GPIO0                   ((gpio_reg*)GPIO0_BASE)
#define     GPIO1                   ((gpio_reg*)GPIO1_BASE)
#define     GPIO2                   ((gpio_reg*)GPIO2_BASE)
#define     GPIO3                   ((gpio_reg*)GPIO3_BASE)
#define     GPIO4                   ((gpio_reg*)GPIO4_BASE)
